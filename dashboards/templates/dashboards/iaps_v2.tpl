    ...
    "widgets": [
        {
            ...
            "properties": {
                "metrics": [
                    [ "CWAgent", "Paging File % Usage", "instance", "\\??\\C:\\pagefile.sys", "AutoScalingGroupName", "${environment_name}-${project_name}-iapsv2-asg", "objectname", "Paging File", { "color": "#d62728" } ],
                    [ ".", "Memory % Committed Bytes In Use", "AutoScalingGroupName", "${environment_name}-${project_name}-iapsv2-asg", "objectname", "Memory", { "label": "Memory % Committed Bytes In Use", "color": "#2ca02c" } ]
                ],
                "view": "timeSeries",
                "stacked": false,
                "region": "${region}",
        ...
        },
        {
            ...
            "properties": {
                ...
                "stacked": false,
                "metrics": [
                    [ "CWAgent", "PhysicalDisk % Disk Time", "instance", "0 C:", "AutoScalingGroupName", "${environment_name}-${project_name}-iapsv2-asg", "objectname", "PhysicalDisk" ],
        ...
        },
        {
            ...
            "properties": {
                "metrics": [
                    [ "CWAgent", "Processor % Idle Time", "instance", "_Total", "AutoScalingGroupName", "${environment_name}-${project_name}-iapsv2-asg", "objectname", "Processor", { "color": "#2ca02c", "stat": "Minimum", "period": 60 } ],
